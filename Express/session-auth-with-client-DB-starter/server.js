...
//Connect to mongoose
mongoose
  .connect("mongodb+srv://utsavu858:eynD6Q6Q03hMtTKZ@utsav-cluster.osnhx.mongodb.net/students-database")
  .then(() => {
...
app.use(
  session({
    ...
    store: MongoStore.create({
      mongoUrl: "mongodb+srv://utsavu858:eynD6Q6Q03hMtTKZ@utsav-cluster.osnhx.mongodb.net/students-database",
    }),
  })
);
